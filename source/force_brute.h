...
** Last update Thu Dec  8 17:02:24 2016 Rouanet Quentin
*/
 ...
 * @return char*
 */
char *format_msg(char *word, int x, int y, int ori);
 ...
 * @return char*
 */
char *force_brute(char **map, char **word, int xmax, int ymax); // c'est moche et completement DEBILE !
 ...
 * @return int
 */
int check_mot(char **map, int i, int y, char *word);
